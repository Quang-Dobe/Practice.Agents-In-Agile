...
- `root/.claude/output-styles/` — versioned output styles installed to `~/.claude/output-styles/`: `ELI5.md` (the globally active style `[R-BRIEF]` defers to)
