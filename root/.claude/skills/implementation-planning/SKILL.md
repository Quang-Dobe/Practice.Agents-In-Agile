...
5. Save via `Write`. Hand off per `pipeline-protocol`: "Stage 2-plan complete. Awaiting user APPROVE on `<feature>.plan.md`. After APPROVE, `status.md` is initialized mechanically and `/feature:implement <feature>` begins implementation."
