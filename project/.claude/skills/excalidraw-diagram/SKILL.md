...
**Setup:** If the user asks you to set up this skill (renderer, dependencies, etc.), see `UPSTREAM-README.md` for instructions.

## Vendored copy — what was changed

This is a vendored copy of `coleam00/excalidraw-diagram-skill`, read 2026-08-22. Four
