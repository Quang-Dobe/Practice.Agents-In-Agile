...
`.claude-root/skills/wiki-memory/SKILL.md` (authored in Step D). When source is read at
...
```
.claude-root/skills/wiki-memory/SKILL.md
```
...
the T5 source read, and **reports** that `.claude-root/skills/wiki-memory/SKILL.md` is
